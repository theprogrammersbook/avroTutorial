...
public class ThePerson extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Creates a new ThePerson RecordBuilder */
  public static com.theprogrammersbook.avro.ThePerson.Builder newBuilder() {
    return new com.theprogrammersbook.avro.ThePerson.Builder();
  }
  
  /** Creates a new ThePerson RecordBuilder by copying an existing Builder */
  public static com.theprogrammersbook.avro.ThePerson.Builder newBuilder(com.theprogrammersbook.avro.ThePerson.Builder other) {
    return new com.theprogrammersbook.avro.ThePerson.Builder(other);
  }
  
  /** Creates a new ThePerson RecordBuilder by copying an existing ThePerson instance */
  public static com.theprogrammersbook.avro.ThePerson.Builder newBuilder(com.theprogrammersbook.avro.ThePerson other) {
    return new com.theprogrammersbook.avro.ThePerson.Builder(other);
  }
  
  /**
   * RecordBuilder for ThePerson instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ThePerson>
    implements org.apache.avro.data.RecordBuilder<ThePerson> {
    ...
    private Builder() {
      super(com.theprogrammersbook.avro.ThePerson.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.theprogrammersbook.avro.ThePerson.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing ThePerson instance */
    private Builder(com.theprogrammersbook.avro.ThePerson other) {
            super(com.theprogrammersbook.avro.ThePerson.SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'id' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setId(int value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearId() {
    ...
    /** Sets the value of the 'username' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setUsername(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearUsername() {
      username = null;
    ...
    /** Sets the value of the 'email_address' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setEmailAddress(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearEmailAddress() {
      email_address = null;
    ...
    /** Sets the value of the 'phone_number' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setPhoneNumber(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearPhoneNumber() {
      phone_number = null;
    ...
    /** Sets the value of the 'first_name' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setFirstName(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearFirstName() {
      first_name = null;
    ...
    /** Sets the value of the 'last_name' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setLastName(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearLastName() {
      last_name = null;
    ...
    /** Sets the value of the 'middle_name' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setMiddleName(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearMiddleName() {
      middle_name = null;
    ...
    /** Sets the value of the 'sex' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setSex(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearSex() {
      sex = null;
    ...
    /** Sets the value of the 'birthdate' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setBirthdate(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearBirthdate() {
      birthdate = null;
    ...
    /** Sets the value of the 'join_date' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setJoinDate(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearJoinDate() {
      join_date = null;
    ...
    /** Sets the value of the 'previous_logins' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setPreviousLogins(java.lang.Integer value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearPreviousLogins() {
    ...
    /** Sets the value of the 'last_ip' field */
    public com.theprogrammersbook.avro.ThePerson.Builder setLastIp(java.lang.CharSequence value) {
    ...
    public com.theprogrammersbook.avro.ThePerson.Builder clearLastIp() {
      last_ip = null;
    ...
    @Override
    public ThePerson build() {
      try {
        ThePerson record = new ThePerson();
